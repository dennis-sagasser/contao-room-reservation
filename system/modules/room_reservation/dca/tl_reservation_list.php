...
(
    ...
    (
        ...
        (  
            ...
            'delete' => array
            (
                'label'             => &$GLOBALS['TL_LANG']['tl_reservation_list']['delete'],
                'href'              => 'act=delete',
                'icon'              => 'delete.gif',
                'attributes'        => 'onclick="if(!confirm(\'' . $GLOBALS['TL_LANG']['tl_reservation_list']['deleteConfirm'] . '\'))return false;Backend.getScrollOffset()"',
            ),
        ) 
    ), 
    // Fields
