...
$GLOBALS['TL_LANG']['MSC']['notEnoughRoomsError']        = 'Nicht genügend Zimmer frei in diesem Zeitraum.';
$GLOBALS['TL_LANG']['MSC']['noRoomsForRoomtype']         = 'Keine Zimmer frei für Zimmertyp "%s" in diesem Zeitraum.';
$GLOBALS['TL_LANG']['MSC']['notEnoughRoomsForTypeError'] = 'Nicht genügend Zimmer frei für Zimmertyp "%s" in diesem Zeitraum.';
